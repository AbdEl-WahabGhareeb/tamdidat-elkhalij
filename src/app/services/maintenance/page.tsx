...
const OG_IMAGE = `${SITE_URL}/assets/services/maintenance/og-image.jpg`;
...
export const metadata = {
    ...
    openGraph: {
        ...
        title: 'صيانة شبكات الغاز - خدمات صيانة دورية وعلاجية',
        description: 'خدمات صيانة شاملة وآمنة لأنظمة الغاز مع كشف تسريبات احترافي',
        images: [
            {
                url: OG_IMAGE,
                width: 1200,
                height: 630,
                alt: 'خدمة صيانة شبكات الغاز',
                type: 'image/jpeg',
                secureUrl: OG_IMAGE,
            },
            {
    ...
    twitter: {
        ...
        title: 'صيانة شبكات الغاز - تمديدات الخليج',
        description: 'خدمات صيانة دورية وعلاجية وطارئة لأنظمة الغاز',
