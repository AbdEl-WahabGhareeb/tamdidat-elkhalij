    ...
    return (
        <>
            <div
                ...
                dir="rtl"
            >
                <div className="relative md:translate-y-28 ms-auto col-span-1 md:col-span-4 lg:translate-y-5 sm:h-[600px] md:w-[90%] md:h-[350px]  lg:right-0 lg:w-[330px] me-auto w-full md:mb-16 mb-6 lg:mb-0 h-[500px] lg:h-[400px] bg-blue-900 rounded-4xl top-0  ">
