    ...
    return (
        <>
            <div
                ...
                dir="rtl"
            >
                <div className="relative md:translate-y-28 ms-auto col-span-4 lg:translate-y-5 md:w-[90%] md:h-[520px] lg:right-[10%] lg:w-[330px] w-full mb-16 lg:mb-0 h-[600px] lg:h-[400px] bg-blue-900 rounded-3xl top-0  ">
